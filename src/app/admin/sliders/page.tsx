                        ...
                        {sliders.length === 0 ? (
                            ...
                            sliders.map(slider => (
                                <tr key={slider.slider_id}>
                                    ...
                                    <td className="py-4 px-4 border-b">
                                        <Link
                                            href={`/admin/sliders/view-slider/${slider.slider_id}`}
                                            className="bg text-white py-2 px-6 rounded-md flex items-center justify-center w-28"
                                        >
