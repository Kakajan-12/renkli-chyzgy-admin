...
const AddAboutGallery = () => {
    ...
    const router = useRouter();
       ...
       const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/about-gallery`, {
                method: 'POST',
                headers: {
        ...
        <div className="flex bg-gray-200">
            ...
            <div className="flex-1 p-10 ml-62">
                ...
                <div className="mt-8">
                    ...
                    >
                        <h2 className="text-2xl font-bold mb-4 text-left">Add new about gallery</h2>
...
export default AddAboutGallery;
