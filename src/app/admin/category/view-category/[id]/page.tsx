    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/category/${id}`, {
                    headers: {
                    ...
                    <div className="bg-white p-4 rounded-md border-gray-200 flex">
                        <div className="space-y-2 ml-4">
                            <div className="mb-10">
                                ...
                                {data.category && (
                                    <div dangerouslySetInnerHTML={{__html: data.category}}/>
                                )}
                            </div>
                        </div>
                    </div>
                ...
                {showModal && (
                    <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 z-50">
                        <div className="bg-white p-6 rounded shadow-md w-96">
                            <h2 className="text-lg font-bold mb-4">Remove category</h2>
